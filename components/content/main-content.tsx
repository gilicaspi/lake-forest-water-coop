...
export const MainContent: React.FC = () => {
  return (
    <div className='flex w-full flex-col self-center p-6 text-gray-700 md:w-[800px]'>
      ...
      {/* Baby markdown */}
      <Section
        content={SECTION_COPY.water_sys_info.content}
        title={SECTION_COPY.water_sys_info.title}
        className={'mb-6'}
      />
      <Section content={SECTION_COPY.input_oppty.content} title={SECTION_COPY.input_oppty.title} className={'mb-6'} />
      <Section content={SECTION_COPY.health_info.content} title={SECTION_COPY.health_info.title} className={'mb-6'} />

      {/*  TODO: Gil Note: Bring back the tables */}
      <div className='mb-6 flex flex-col'>
        ...
        <div className='mb-6 table w-full'>
          <div className='table-header-group bg-gray-100'>
            <div className='table-row'>
              <div className='table-cell py-2 text-left'>Source ID</div>
              <div className='table-cell py-2 text-left'>Source</div>
              <div className='table-cell py-2 text-left'>Depth (in feet)</div>
              <div className='table-cell py-2 text-left'>Status</div>
            </div>
          </div>
          <div className='table-row-group'>
            <div className='table-row'>
              <div className='table-cell text-left'>1</div>
              <div className='table-cell text-left'>Groundwater</div>
              <div className='table-cell text-left'>147</div>
              <div className='table-cell text-left'>Active</div>
            </div>
            <tr className='table-row'>
              <div className='table-cell text-left'>2</div>
              <div className='table-cell text-left'>Groundwater</div>
              <div className='table-cell text-left'>253</div>
              <div className='table-cell text-left'>Active</div>
            </tr>
          </div>
        </div>
      ...
      <Section content={SECTION_COPY.addl_health_info.content} title={SECTION_COPY.addl_health_info.title} />
    </div>
